  ...
  return (
    <form className="mx-auto max-w-xl py-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      {address && 
        <>
          <div className="mt-4">
            <label htmlFor="image" className="p-4 border-dashed border-4 border-gray-600 block cursor-pointer">Click to add venue image</label>
            <input 
              id="image" 
              name="image" 
              type="file" 
          ...
          <div className="mt-4">
            ...
            <input type="text" name="venue" id="venue" className="p-2" ref={register({
          ...
          <div className="mt-4">
            ...
            <input type="number" min={1} name="capacity" id="capacity" className="p-2" ref={register({
